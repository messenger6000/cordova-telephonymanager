...
TelephonyManagerInfo.prototype.getCellTowerInfo = function(successCallback, errorCallback) {
    exec(successCallback, errorCallback, "TelephonyManagerInfo", "getCellTowerInfo", []);
};
